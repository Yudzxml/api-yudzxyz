...
module.exports = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ status: 200, author: 'Yudzxml', ...result });
  } catch (err) {
...
Berikut perbaikan kode dengan memperbaiki penggunaan template literal dan string pada console.log, throw new Error, serta .end dan respon error. Sekarang kode akan terkompilasi dengan benar dan merespons sesuai penerimaan request:
